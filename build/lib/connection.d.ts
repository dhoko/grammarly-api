 ...
 */
export declare function buildWSOptions(auth: Auth, agent?: WebSocket.ClientOptions['agent']): WebSocket.ClientOptions;
/**
 * Connect to the remote WebSocket
 *
 * @param userAuth a custom user auth object
 */
export declare function connect(userAuth?: RequiredAuth, agent?: WebSocket.ClientOptions['agent']): Promise<Connection>;
